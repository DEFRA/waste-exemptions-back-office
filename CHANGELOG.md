...
- Bump rubocop-rails from 2.36.0 to 2.37.0 [\#2140](https://github.com/DEFRA/waste-exemptions-back-office/pull/2140) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump selenium-webdriver from 4.46.0 to 4.47.0 [\#2138](https://github.com/DEFRA/waste-exemptions-back-office/pull/2138) ([dependabot[bot]](https://github.com/apps/dependabot))

## [v4.2.4](https://github.com/defra/waste-exemptions-back-office/tree/v4.2.4) (2026-08-06)

[Full Changelog](https://github.com/defra/waste-exemptions-back-office/compare/v4.2.3...v4.2.4)

**Implemented enhancements:**

- \[RUBY-4343\] Add a rake task to clean up people records that are not a… [\#2131](https://github.com/DEFRA/waste-exemptions-back-office/pull/2131) ([brujeo](https://github.com/brujeo))
- Feature/ruby 4364 wex bo identify and fix broken registration data [\#2126](https://github.com/DEFRA/waste-exemptions-back-office/pull/2126) ([brujeo](https://github.com/brujeo))
- \[RUBY-4017\] Add resend invite for back office users [\#2122](https://github.com/DEFRA/waste-exemptions-back-office/pull/2122) ([jjromeo](https://github.com/jjromeo))

**Merged pull requests:**

- Release/v4.2.4 [\#2136](https://github.com/DEFRA/waste-exemptions-back-office/pull/2136) ([brujeo](https://github.com/brujeo))
- Bump activestorage from 7.2.3.1 to 7.2.3.2 [\#2133](https://github.com/DEFRA/waste-exemptions-back-office/pull/2133) ([dependabot[bot]](https://github.com/apps/dependabot))

## [v4.2.3](https://github.com/defra/waste-exemptions-back-office/tree/v4.2.3) (2026-07-06)

[Full Changelog](https://github.com/defra/waste-exemptions-back-office/compare/v4.2.2...v4.2.3)

**Implemented enhancements:**

- Update deactivated account message to include contact email [\#2107](https://github.com/DEFRA/waste-exemptions-back-office/pull/2107) ([brujeo](https://github.com/brujeo))
- \[RUBY-4324\] Add rake task to check and update EA areas for active registrations [\#2105](https://github.com/DEFRA/waste-exemptions-back-office/pull/2105) ([jjromeo](https://github.com/jjromeo))

**Merged pull requests:**

- Release v4.2.3 [\#2118](https://github.com/DEFRA/waste-exemptions-back-office/pull/2118) ([jjromeo](https://github.com/jjromeo))
- Bump waste\_exemptions\_engine from `e25ef43` to `63fb2cf` [\#2117](https://github.com/DEFRA/waste-exemptions-back-office/pull/2117) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump dependencies [\#2115](https://github.com/DEFRA/waste-exemptions-back-office/pull/2115) ([brujeo](https://github.com/brujeo))
- Feature/ruby 4332 wex security enable bundler cooldown give new gems a few days to be vetted [\#2112](https://github.com/DEFRA/waste-exemptions-back-office/pull/2112) ([brujeo](https://github.com/brujeo))
...
[Full Changelog](https://github.com/defra/waste-exemptions-back-office/compare/v4.2.1...v4.2.2)
...
- Update CHANGELOG.md for v4.2.2 [\#2098](https://github.com/DEFRA/waste-exemptions-back-office/pull/2098) ([jjromeo](https://github.com/jjromeo))
...
- \[RUBY-4189\] Add vertical alignment to payment details table cells [\#2066](https://github.com/DEFRA/waste-exemptions-back-office/pull/2066) ([jjromeo](https://github.com/jjromeo))
- \[RUBY-4208\] Add site count display with pluralization in resource site addresses [\#2065](https://github.com/DEFRA/waste-exemptions-back-office/pull/2065) ([jjromeo](https://github.com/jjromeo))
- \[RUBY-4189\] Display free exemptions on their own row in payment details [\#2059](https://github.com/DEFRA/waste-exemptions-back-office/pull/2059) ([jjromeo](https://github.com/jjromeo))
- \[RUBY-4208\] Refactor resource details layout for improved readability and structure [\#2055](https://github.com/DEFRA/waste-exemptions-back-office/pull/2055) ([jjromeo](https://github.com/jjromeo))

**Fixed bugs:**

- \[RUBY-4189\] Add charge breakdown cell styles and update presenter class names [\#2069](https://github.com/DEFRA/waste-exemptions-back-office/pull/2069) ([jjromeo](https://github.com/jjromeo))
...
- Bump waste\_exemptions\_engine from `5cb9ab7` to `ea2eb9b` [\#2058](https://github.com/DEFRA/waste-exemptions-back-office/pull/2058) ([dependabot[bot]](https://github.com/apps/dependabot))
- \[RUBY-4199\] Refactor action links to be buttons styled as links [\#2054](https://github.com/DEFRA/waste-exemptions-back-office/pull/2054) ([brujeo](https://github.com/brujeo))
- Feature/ruby 4211 wex bo resend confirmation email action remove sending to applicant [\#2053](https://github.com/DEFRA/waste-exemptions-back-office/pull/2053) ([brujeo](https://github.com/brujeo))

## [v4.2.0](https://github.com/defra/waste-exemptions-back-office/tree/v4.2.0) (2026-03-27)

[Full Changelog](https://github.com/defra/waste-exemptions-back-office/compare/v4.1.0...v4.2.0)

**Implemented enhancements:**

- \[RUBY-4160\] remove special renewal reminders for charities  [\#2041](https://github.com/DEFRA/waste-exemptions-back-office/pull/2041) ([brujeo](https://github.com/brujeo))
- \[RUBY-4234\] Adjusting seed data with increased charge fees  [\#2040](https://github.com/DEFRA/waste-exemptions-back-office/pull/2040) ([brujeo](https://github.com/brujeo))
- \[RUBY-4175\] Display charitable purpose on registration view page [\#2037](https://github.com/DEFRA/waste-exemptions-back-office/pull/2037) ([brujeo](https://github.com/brujeo))
- \[RUBY-4201\] Add summary and no compliance charge rows to finance data report [\#2026](https://github.com/DEFRA/waste-exemptions-back-office/pull/2026) ([jjromeo](https://github.com/jjromeo))
- \[RUBY-4116\] Add devise-security session\_limitable to restrict simultaneous logins [\#2023](https://github.com/DEFRA/waste-exemptions-back-office/pull/2023) ([brujeo](https://github.com/brujeo))

**Fixed bugs:**

- \[RUBY-4184\] Use different pagination param for sites navigation [\#2046](https://github.com/DEFRA/waste-exemptions-back-office/pull/2046) ([brujeo](https://github.com/brujeo))
- Fix/ruby 4175 ensure charitable status shown when value is false [\#2038](https://github.com/DEFRA/waste-exemptions-back-office/pull/2038) ([brujeo](https://github.com/brujeo))
- RUBY 4201 wex alter finance data export to show current balance of registrations [\#2029](https://github.com/DEFRA/waste-exemptions-back-office/pull/2029) ([jjromeo](https://github.com/jjromeo))

**Merged pull requests:**

- Release v4.2.0 [\#2051](https://github.com/DEFRA/waste-exemptions-back-office/pull/2051) ([jjromeo](https://github.com/jjromeo))
- Chore/bump deps 2026 03 25 [\#2050](https://github.com/DEFRA/waste-exemptions-back-office/pull/2050) ([brujeo](https://github.com/brujeo))
- Bump waste\_exemptions\_engine from `842f7c3` to `5cb9ab7` [\#2049](https://github.com/DEFRA/waste-exemptions-back-office/pull/2049) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump waste\_exemptions\_engine from `e54b99e` to `842f7c3` [\#2048](https://github.com/DEFRA/waste-exemptions-back-office/pull/2048) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump waste\_exemptions\_engine from `6db0657` to `e54b99e` [\#2047](https://github.com/DEFRA/waste-exemptions-back-office/pull/2047) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump waste\_exemptions\_engine from `7b37d60` to `6db0657` [\#2045](https://github.com/DEFRA/waste-exemptions-back-office/pull/2045) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump webmock from 3.26.1 to 3.26.2 [\#2044](https://github.com/DEFRA/waste-exemptions-back-office/pull/2044) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump waste\_exemptions\_engine from `84e54e4` to `7b37d60` [\#2043](https://github.com/DEFRA/waste-exemptions-back-office/pull/2043) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump waste\_exemptions\_engine from `ec65f9e` to `84e54e4` [\#2039](https://github.com/DEFRA/waste-exemptions-back-office/pull/2039) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump waste\_exemptions\_engine from `c32843e` to `ec65f9e` [\#2036](https://github.com/DEFRA/waste-exemptions-back-office/pull/2036) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump rspec-rails from 8.0.3 to 8.0.4 [\#2035](https://github.com/DEFRA/waste-exemptions-back-office/pull/2035) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump waste\_exemptions\_engine from `a9d5065` to `c32843e` [\#2034](https://github.com/DEFRA/waste-exemptions-back-office/pull/2034) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump waste\_exemptions\_engine from `ec47872` to `a9d5065` [\#2033](https://github.com/DEFRA/waste-exemptions-back-office/pull/2033) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump waste\_exemptions\_engine from `98c93d1` to `ec47872` [\#2032](https://github.com/DEFRA/waste-exemptions-back-office/pull/2032) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump waste\_exemptions\_engine from `69a6bfb` to `98c93d1` [\#2031](https://github.com/DEFRA/waste-exemptions-back-office/pull/2031) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump waste\_exemptions\_engine from `47f8474` to `69a6bfb` [\#2030](https://github.com/DEFRA/waste-exemptions-back-office/pull/2030) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump defra\_ruby\_aws from 0.5.1 to 0.6.0 [\#2025](https://github.com/DEFRA/waste-exemptions-back-office/pull/2025) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump waste\_exemptions\_engine from `d7f7846` to `47f8474` [\#2024](https://github.com/DEFRA/waste-exemptions-back-office/pull/2024) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump waste\_exemptions\_engine from `aa30f27` to `d7f7846` [\#2022](https://github.com/DEFRA/waste-exemptions-back-office/pull/2022) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump waste\_exemptions\_engine from `7d2313f` to `aa30f27` [\#2021](https://github.com/DEFRA/waste-exemptions-back-office/pull/2021) ([dependabot[bot]](https://github.com/apps/dependabot))

## [v4.1.0](https://github.com/defra/waste-exemptions-back-office/tree/v4.1.0) (2026-02-23)

[Full Changelog](https://github.com/defra/waste-exemptions-back-office/compare/v4.0.1...v4.1.0)
...
- Release v4.1.0 [\#2020](https://github.com/DEFRA/waste-exemptions-back-office/pull/2020) ([jjromeo](https://github.com/jjromeo))
...
- Feature/ruby 3993 legacy bulk renewal reminders [\#1974](https://github.com/DEFRA/waste-exemptions-back-office/pull/1974) ([PaulDoyle-EA](https://github.com/PaulDoyle-EA))
- \[RUBY-4068\] Support multisite registration in testing endpoint [\#1958](https://github.com/DEFRA/waste-exemptions-back-office/pull/1958) ([jjromeo](https://github.com/jjromeo))
- Feature/ruby 4071 wex bo linear registrations page [\#1939](https://github.com/DEFRA/waste-exemptions-back-office/pull/1939) ([brujeo](https://github.com/brujeo))
- \[RUBY-4070\] Adding indication that registration is a multisite or linear [\#1935](https://github.com/DEFRA/waste-exemptions-back-office/pull/1935) ([brujeo](https://github.com/brujeo))
- \[RUBY-4053\] Add site-specific deregistration details page and shared deregistrations table partial [\#1926](https://github.com/DEFRA/waste-exemptions-back-office/pull/1926) ([jjromeo](https://github.com/jjromeo))
- Feature/nccc reg renewal reminders [\#1924](https://github.com/DEFRA/waste-exemptions-back-office/pull/1924) ([PaulDoyle-EA](https://github.com/PaulDoyle-EA))
- \[RUBY-3950\] Add multisite, organisation\_name, site, payment\_status, and status fields to finance data report CSV export [\#1922](https://github.com/DEFRA/waste-exemptions-back-office/pull/1922) ([jjromeo](https://github.com/jjromeo))
- feature/RUBY-4036\_mark\_reg\_multisite\_linear [\#1917](https://github.com/DEFRA/waste-exemptions-back-office/pull/1917) ([PaulDoyle-EA](https://github.com/PaulDoyle-EA))
- Feature/ruby 3944 multisite epr [\#1908](https://github.com/DEFRA/waste-exemptions-back-office/pull/1908) ([PaulDoyle-EA](https://github.com/PaulDoyle-EA))
- Feature/ruby 3948 wex multiple site registrations bo data export [\#1907](https://github.com/DEFRA/waste-exemptions-back-office/pull/1907) ([brujeo](https://github.com/brujeo))
- \[RUBY-3992\] Refactor payment details page and add support for multisite registrations [\#1899](https://github.com/DEFRA/waste-exemptions-back-office/pull/1899) ([brujeo](https://github.com/brujeo))
- \[RUBY-3997 & RUBY-3998 & RUBY-3991\] wex bo multisite: registration sites page + exemptions details page + site exemptions deregistration [\#1883](https://github.com/DEFRA/waste-exemptions-back-office/pull/1883) ([brujeo](https://github.com/brujeo))
- \[RUBY-3945\] Displaying multiple site locations on the registration details page [\#1880](https://github.com/DEFRA/waste-exemptions-back-office/pull/1880) ([brujeo](https://github.com/brujeo))
...
- \[RUBY-4068\] Fix issue with audit log including changes to site address that it shouldn't after registration is created from this endpoint. [\#1970](https://github.com/DEFRA/waste-exemptions-back-office/pull/1970) ([jjromeo](https://github.com/jjromeo))
- \[RUBY-3884\] Fix: Add nowrap attribute to table cells for better alignment in payment details [\#1964](https://github.com/DEFRA/waste-exemptions-back-office/pull/1964) ([brujeo](https://github.com/brujeo))
- \[RUBY-4137\] Refactor registration number in EPR report to use configurable site suffix separator with default hyphen [\#1959](https://github.com/DEFRA/waste-exemptions-back-office/pull/1959) ([jjromeo](https://github.com/jjromeo))
- \[RUBY-4090\] Integrate use of the new deregistered\_by field for retaining deregistered by after editing registrations [\#1950](https://github.com/DEFRA/waste-exemptions-back-office/pull/1950) ([jjromeo](https://github.com/jjromeo))
- Fix/ruby 3944 manual site address [\#1911](https://github.com/DEFRA/waste-exemptions-back-office/pull/1911) ([PaulDoyle-EA](https://github.com/PaulDoyle-EA))
- Skip farm compliance charge rows if bucket is missing [\#1888](https://github.com/DEFRA/waste-exemptions-back-office/pull/1888) ([PaulDoyle-EA](https://github.com/PaulDoyle-EA))
- \[RUBY-3978\] rake task to fix stuck user accounts with expired invitations [\#1870](https://github.com/DEFRA/waste-exemptions-back-office/pull/1870) ([brujeo](https://github.com/brujeo))
...
- Feature/ruby 4114 wex ithc outdated jquery library [\#1973](https://github.com/DEFRA/waste-exemptions-back-office/pull/1973) ([brujeo](https://github.com/brujeo))
- Bump rubocop-rails from 2.34.2 to 2.34.3 [\#1972](https://github.com/DEFRA/waste-exemptions-back-office/pull/1972) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump waste\_exemptions\_engine from `54aefdc` to `a52f6d6` [\#1971](https://github.com/DEFRA/waste-exemptions-back-office/pull/1971) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump pg from 1.6.2 to 1.6.3 [\#1969](https://github.com/DEFRA/waste-exemptions-back-office/pull/1969) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump faraday-retry from 2.3.2 to 2.4.0 [\#1968](https://github.com/DEFRA/waste-exemptions-back-office/pull/1968) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump passenger from 6.1.0 to 6.1.1 [\#1967](https://github.com/DEFRA/waste-exemptions-back-office/pull/1967) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump sucker\_punch from 3.2.0 to 3.3.0 [\#1966](https://github.com/DEFRA/waste-exemptions-back-office/pull/1966) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump vcr from 6.3.1 to 6.4.0 [\#1965](https://github.com/DEFRA/waste-exemptions-back-office/pull/1965) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump net-imap from 0.6.0 to 0.6.2 [\#1963](https://github.com/DEFRA/waste-exemptions-back-office/pull/1963) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump waste\_exemptions\_engine from `3dd547d` to `54aefdc` [\#1962](https://github.com/DEFRA/waste-exemptions-back-office/pull/1962) ([dependabot[bot]](https://github.com/apps/dependabot))
- \[RUBY-4132\] Refactor: Remove unnecessary data model checks and simplify implementation [\#1960](https://github.com/DEFRA/waste-exemptions-back-office/pull/1960) ([brujeo](https://github.com/brujeo))
- Chore/ruby 4088 refactor multisite checks [\#1956](https://github.com/DEFRA/waste-exemptions-back-office/pull/1956) ([PaulDoyle-EA](https://github.com/PaulDoyle-EA))
- Bump waste\_exemptions\_engine from `15f5c30` to `8f388a0` [\#1955](https://github.com/DEFRA/waste-exemptions-back-office/pull/1955) ([dependabot[bot]](https://github.com/apps/dependabot))
- Chore/ruby 4095 single multi site spike [\#1949](https://github.com/DEFRA/waste-exemptions-back-office/pull/1949) ([brujeo](https://github.com/brujeo))
- Bump waste\_exemptions\_engine from `169d278` to `f25009e` [\#1947](https://github.com/DEFRA/waste-exemptions-back-office/pull/1947) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump waste\_exemptions\_engine from `4dd46d1` to `169d278` [\#1941](https://github.com/DEFRA/waste-exemptions-back-office/pull/1941) ([dependabot[bot]](https://github.com/apps/dependabot))
- RUBY 4072 wex store number of sites in charge details table [\#1937](https://github.com/DEFRA/waste-exemptions-back-office/pull/1937) ([jjromeo](https://github.com/jjromeo))
- Bump waste\_exemptions\_engine from `dd1db24` to `d2b0c37` [\#1934](https://github.com/DEFRA/waste-exemptions-back-office/pull/1934) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump rubocop-factory\_bot from 2.27.1 to 2.28.0 [\#1933](https://github.com/DEFRA/waste-exemptions-back-office/pull/1933) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump rubocop-rspec\_rails from 2.31.0 to 2.32.0 [\#1932](https://github.com/DEFRA/waste-exemptions-back-office/pull/1932) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump rubocop-rspec from 3.7.0 to 3.8.0 [\#1931](https://github.com/DEFRA/waste-exemptions-back-office/pull/1931) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump waste\_exemptions\_engine from `a80d708` to `dd1db24` [\#1930](https://github.com/DEFRA/waste-exemptions-back-office/pull/1930) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump waste\_exemptions\_engine from `e2e2df7` to `a80d708` [\#1929](https://github.com/DEFRA/waste-exemptions-back-office/pull/1929) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump waste\_exemptions\_engine from `1f1ee05` to `e2e2df7` [\#1928](https://github.com/DEFRA/waste-exemptions-back-office/pull/1928) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump waste\_exemptions\_engine from `ad9d3c9` to `1f1ee05` [\#1927](https://github.com/DEFRA/waste-exemptions-back-office/pull/1927) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump waste\_exemptions\_engine from `e7a643b` to `ad9d3c9` [\#1925](https://github.com/DEFRA/waste-exemptions-back-office/pull/1925) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump govuk\_design\_system\_formbuilder from 5.11.0 to 5.13.0 [\#1921](https://github.com/DEFRA/waste-exemptions-back-office/pull/1921) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump waste\_exemptions\_engine from `c8168a6` to `1350bc9` [\#1920](https://github.com/DEFRA/waste-exemptions-back-office/pull/1920) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump waste\_exemptions\_engine from `f56b3a4` to `d6532d4` [\#1913](https://github.com/DEFRA/waste-exemptions-back-office/pull/1913) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump bullet from 8.0.8 to 8.1.0 [\#1909](https://github.com/DEFRA/waste-exemptions-back-office/pull/1909) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump jquery-rails from 4.6.0 to 4.6.1 [\#1906](https://github.com/DEFRA/waste-exemptions-back-office/pull/1906) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump waste\_exemptions\_engine from `b05dfe6` to `f56b3a4` [\#1905](https://github.com/DEFRA/waste-exemptions-back-office/pull/1905) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump waste\_exemptions\_engine from `5c13615` to `b05dfe6` [\#1902](https://github.com/DEFRA/waste-exemptions-back-office/pull/1902) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump selenium-webdriver from 4.35.0 to 4.37.0 [\#1901](https://github.com/DEFRA/waste-exemptions-back-office/pull/1901) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump sonarsource/sonarqube-scan-action from 5.2.0 to 6.0.0 in /.github/workflows [\#1898](https://github.com/DEFRA/waste-exemptions-back-office/pull/1898) ([dependabot[bot]](https://github.com/apps/dependabot))
- Pin sonarqube action version [\#1897](https://github.com/DEFRA/waste-exemptions-back-office/pull/1897) ([PaulDoyle-EA](https://github.com/PaulDoyle-EA))
- Bump waste\_exemptions\_engine from `f243d5e` to `5c13615` [\#1896](https://github.com/DEFRA/waste-exemptions-back-office/pull/1896) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump waste\_exemptions\_engine from `2bbe923` to `f243d5e` [\#1894](https://github.com/DEFRA/waste-exemptions-back-office/pull/1894) ([dependabot[bot]](https://github.com/apps/dependabot))
- Include additional seed files into main seeds.rb [\#1893](https://github.com/DEFRA/waste-exemptions-back-office/pull/1893) ([brujeo](https://github.com/brujeo))
- \[RUBY-3943\] Add `is\_multisite\_registration` boolean column to registrations table [\#1892](https://github.com/DEFRA/waste-exemptions-back-office/pull/1892) ([jjromeo](https://github.com/jjromeo))
- Bump waste\_exemptions\_engine from `5bda2d1` to `2bbe923` [\#1890](https://github.com/DEFRA/waste-exemptions-back-office/pull/1890) ([dependabot[bot]](https://github.com/apps/dependabot))
- Update ruby and gems [\#1887](https://github.com/DEFRA/waste-exemptions-back-office/pull/1887) ([PaulDoyle-EA](https://github.com/PaulDoyle-EA))
- Bump rubocop-rails from 2.33.3 to 2.33.4 [\#1879](https://github.com/DEFRA/waste-exemptions-back-office/pull/1879) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump waste\_exemptions\_engine from `eddda65` to `3aa494c` [\#1878](https://github.com/DEFRA/waste-exemptions-back-office/pull/1878) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump rack from 2.2.17 to 2.2.18 [\#1877](https://github.com/DEFRA/waste-exemptions-back-office/pull/1877) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump notifications-ruby-client from 6.2.0 to 6.3.0 [\#1876](https://github.com/DEFRA/waste-exemptions-back-office/pull/1876) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump waste\_exemptions\_engine from `198da11` to `eddda65` [\#1875](https://github.com/DEFRA/waste-exemptions-back-office/pull/1875) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump waste\_exemptions\_engine from `82a1627` to `198da11` [\#1873](https://github.com/DEFRA/waste-exemptions-back-office/pull/1873) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump passenger from 6.0.22 to 6.1.0 [\#1871](https://github.com/DEFRA/waste-exemptions-back-office/pull/1871) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump waste\_exemptions\_engine from `1ea7a1d` to `82a1627` [\#1869](https://github.com/DEFRA/waste-exemptions-back-office/pull/1869) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump factory\_bot\_rails from 6.5.0 to 6.5.1 [\#1867](https://github.com/DEFRA/waste-exemptions-back-office/pull/1867) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump hashdiff from 1.2.0 to 1.2.1 [\#1866](https://github.com/DEFRA/waste-exemptions-back-office/pull/1866) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump pg from 1.6.1 to 1.6.2 [\#1865](https://github.com/DEFRA/waste-exemptions-back-office/pull/1865) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump rubocop-rspec from 3.6.0 to 3.7.0 [\#1864](https://github.com/DEFRA/waste-exemptions-back-office/pull/1864) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump net-imap from 0.5.9 to 0.5.10 [\#1863](https://github.com/DEFRA/waste-exemptions-back-office/pull/1863) ([dependabot[bot]](https://github.com/apps/dependabot))
...
- \[RUBY-3914\] Override scope to exclude placeholder registrations in search [\#1852](https://github.com/DEFRA/waste-exemptions-back-office/pull/1852) ([jjromeo](https://github.com/jjromeo))
- \[RUBY-3932\] Filter finance export to include only successful card payments [\#1845](https://github.com/DEFRA/waste-exemptions-back-office/pull/1845) ([jjromeo](https://github.com/jjromeo))
- \[RUBY-3764\] Update waste\_exemptions\_engine branch and improve EA Public Face Area data loading [\#1838](https://github.com/DEFRA/waste-exemptions-back-office/pull/1838) ([jjromeo](https://github.com/jjromeo))

**Merged pull requests:**

- Release/v3.2.0 [\#1861](https://github.com/DEFRA/waste-exemptions-back-office/pull/1861) ([PaulDoyle-EA](https://github.com/PaulDoyle-EA))
- Version 3.0.2 [\#1848](https://github.com/DEFRA/waste-exemptions-back-office/pull/1848) ([PaulDoyle-EA](https://github.com/PaulDoyle-EA))
- Bump waste\_exemptions\_engine from `b62189d` to `283f795` [\#1844](https://github.com/DEFRA/waste-exemptions-back-office/pull/1844) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump waste\_exemptions\_engine from `b0ca1d5` to `b62189d` [\#1843](https://github.com/DEFRA/waste-exemptions-back-office/pull/1843) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump pg from 1.5.9 to 1.6.0 [\#1842](https://github.com/DEFRA/waste-exemptions-back-office/pull/1842) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump waste\_exemptions\_engine from `9d15140` to `41b92d8` [\#1839](https://github.com/DEFRA/waste-exemptions-back-office/pull/1839) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump waste\_exemptions\_engine from `f7c7c9b` to `9d15140` [\#1837](https://github.com/DEFRA/waste-exemptions-back-office/pull/1837) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump waste\_exemptions\_engine from `2cb04dd` to `f7c7c9b` [\#1835](https://github.com/DEFRA/waste-exemptions-back-office/pull/1835) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump waste\_exemptions\_engine from `719cd8c` to `9a87d63` [\#1833](https://github.com/DEFRA/waste-exemptions-back-office/pull/1833) ([dependabot[bot]](https://github.com/apps/dependabot))
- Restoring dependabot settings so it can pull engine updates [\#1832](https://github.com/DEFRA/waste-exemptions-back-office/pull/1832) ([brujeo](https://github.com/brujeo))
- Bump faker from 3.5.1 to 3.5.2 [\#1830](https://github.com/DEFRA/waste-exemptions-back-office/pull/1830) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump selenium-webdriver from 4.33.0 to 4.34.0 [\#1826](https://github.com/DEFRA/waste-exemptions-back-office/pull/1826) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump govuk\_design\_system\_formbuilder from 5.10.1 to 5.11.0 [\#1823](https://github.com/DEFRA/waste-exemptions-back-office/pull/1823) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump rspec-rails from 8.0.0 to 8.0.1 [\#1817](https://github.com/DEFRA/waste-exemptions-back-office/pull/1817) ([dependabot[bot]](https://github.com/apps/dependabot))
- Bump faraday-retry from 2.3.1 to 2.3.2 [\#1816](https://github.com/DEFRA/waste-exemptions-back-office/pull/1816) ([dependabot[bot]](https://github.com/apps/dependabot))
- \[RUBY-3764\] Add functionality to load EA areas into the database for use with the new local, geospatial lookup of areas [\#1785](https://github.com/DEFRA/waste-exemptions-back-office/pull/1785) ([jjromeo](https://github.com/jjromeo))
...
- \[RUBY-3618\] Update schema to add `temp\_add\_additional\_non\_farm\_exemptions` column [\#1659](https://github.com/DEFRA/waste-exemptions-back-office/pull/1659) ([jjromeo](https://github.com/jjromeo))
...
- \[RUBY-3571\] Add `invited\_at` timestamp to BetaParticipant creation [\#1616](https://github.com/DEFRA/waste-exemptions-back-office/pull/1616) ([jjromeo](https://github.com/jjromeo))
- \[RUBY-3571\] Add `invited\_at` timestamp to `BetaParticipant` creation [\#1613](https://github.com/DEFRA/waste-exemptions-back-office/pull/1613) ([jjromeo](https://github.com/jjromeo))
