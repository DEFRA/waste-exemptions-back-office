...
class OperationSitesForm < WasteExemptionsEngine::BaseForm
  ...
  def site_status(address)
    ...
    regexemptions = regexemptions.where(transient_address: address) if transient_registration.is_multisite_registration
