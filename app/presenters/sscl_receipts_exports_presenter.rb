...
class SsclReceiptsExportsPresenter
  ...
  def exported_at_message
    return I18n.t("data_exports.show.sscl_receipts.not_yet_exported") if export_executed_at.blank?

    export_executed_at_string = export_executed_at.to_fs(:time_on_day_month_year)
    I18n.t("data_exports.show.sscl_receipts.exported_at", export_executed_at: export_executed_at_string)
  end
  ...
  def generated_reports_scope
    Reports::GeneratedReport.sscl_receipts.order(created_at: :desc)
  end
