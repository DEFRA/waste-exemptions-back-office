...
RSpec.describe PlaceholderRegistrationCleanupService do
  describe ".run" do
    ...
    let!(:placeholder_registration_5_days) { create(:registration, lifecycle_status: "placeholder", created_at: 5.days.ago) }
    let!(:placeholder_registration_8_days) { create(:registration, lifecycle_status: "placeholder", created_at: 8.days.ago) }
    let!(:completed_registration) { create(:registration, lifecycle_status: "complete") }
    let!(:nil_status_registration) { create(:registration, lifecycle_status: nil) }
